...
def _make_folder_preview(Gtk, GdkPixbuf, Gdk, base_dir, token):
    """Return a small Image of the theme's folder icon (generated by gen-surfn-list.py)."""
    img = Gtk.Image()
    try:
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(base_dir + "/images/surfn/" + token + ".png", 24, 24)
...
Ensure that the <b>Nemesis repo is enabled</b> — see the "Pacman" tab for details.'
    ...
    flowbox_neocandy.set_max_children_per_line(10)
    flowbox_neocandy.set_selection_mode(Gtk.SelectionMode.NONE)

    flowbox_neocandy.append(self.att_candy_beauty)
    flowbox_neocandy.append(self.edu_candy_beauty_arc)
    flowbox_neocandy.append(self.edu_candy_beauty_arc_mint_grey)
    flowbox_neocandy.append(self.edu_candy_beauty_arc_mint_red)
    flowbox_neocandy.append(self.edu_candy_beauty_tela)
    flowbox_neocandy.append(self.edu_papirus_dark_tela)
    flowbox_neocandy.append(self.edu_papirus_dark_tela_grey)
    flowbox_neocandy.append(self.edu_vimix_dark_tela)
    flowbox_neocandy.append(self.edu_neo_candy_qogir)
