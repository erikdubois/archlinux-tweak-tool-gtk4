...
def gui(self, Gtk, vboxstack_system, fn):
    ...
    btn1.connect("clicked", functools.partial(system.on_click_system_cpu, self))
    ...
    btn2.connect("clicked", functools.partial(system.on_click_system_memory_disk, self))
    ...
    btn3.connect("clicked", functools.partial(system.on_click_system_lsblk, self))
    ...
    btn4.connect("clicked", functools.partial(system.on_click_system_lspci, self))
    ...
    btn5.connect("clicked", functools.partial(system.on_click_system_lsusb, self))
    ...
    btn6.connect("clicked", functools.partial(system.on_click_system_lsmod, self))
    ...
    btn7.connect("clicked", functools.partial(system.on_click_system_inxi, self))
    ...
    btn8.connect("clicked", functools.partial(system.on_click_system_hwinfo, self))
    ...
    btn9.connect("clicked", functools.partial(system.on_click_system_fdisk, self))
    ...
    btn10.connect("clicked", functools.partial(system.on_click_system_fstab, self))
    ...
    btn11.connect("clicked", functools.partial(system.on_click_system_hostnamectl, self))
    ...
    btn12.connect("clicked", functools.partial(system.on_click_system_localectl, self))
    ...
    btn13.connect("clicked", functools.partial(system.on_click_system_services, self))
    ...
    btn14.connect("clicked", functools.partial(system.on_click_system_services_enabled, self))
    ...
    btn15.connect("clicked", functools.partial(system.on_click_system_services_failed, self))
    ...
    btn16.connect("clicked", functools.partial(system.on_click_system_timers_enabled, self))
    ...
    btn17.connect("clicked", functools.partial(system.on_click_system_dmesg, self))
    ...
    btn18.connect("clicked", functools.partial(system.on_click_system_gparted, self))
