...
def gui(self, Gtk, vboxstack27, performance, fn):
    ...
    hbox7.append(self.tuned_package_label)
    ...
    hbox7c.append(self.tuned_status_label)
    ...
    hbox7c.append(self.restart_tuned_ppd)
    ...
    hbox7d.append(self.tuned_ppd_status_label)
    ...
    hbox12.append(self.swapfile_label)
    ...
    vboxstack27.append(hbox25)
    vboxstack27.append(hbox26)
    vboxstack27.append(hbox27)
    vboxstack27.append(hbox28)
